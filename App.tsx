...
export const SERVICES: ServiceSlug[] = [
  {
    ...
    overview: 'Our tax advisory team delivers proactive, forward-thinking tax planning that minimises liabilities while maintaining full HMRC compliance. We look beyond the current tax year to build strategies that protect and grow your wealth.',
    benefits: [
      'Reduce your tax liability legally and sustainably',
      'Full compliance with all HMRC requirements',
    ...
    process: [
      ...
      { step: '03', title: 'Implementation', desc: 'We execute the strategy and handle all HMRC communications on your behalf.' },
    ...
    faqs: [
      ...
      { q: 'Do you handle HMRC investigations?', a: 'Yes. We provide full representation and support throughout HMRC enquiries and investigations, protecting your interests at every stage.' },
      { q: 'Is your advice ICAEW compliant?', a: 'Absolutely. All advice is given by qualified ICAEW members and adheres strictly to professional standards and HMRC regulations.' },
    ],
  },
  {
    id: 'bookkeeping',
  ...
  },
  {
    ...
    icon: '💳',
    color: '#7b3f00',
    heroDesc: 'Full-service payroll management for UK businesses, handling everything from calculations to HMRC submissions.',
    ...
    benefits: [
      ...
      'RTI submissions to HMRC on every payroll',
    ...
    process: [
      ...
      { step: '04', title: 'Year-End P60s', desc: 'All P60s issued to employees and P11Ds filed by the HMRC deadline.' },
    ],
    faqs: [
      { q: 'What if I have employees joining or leaving?', a: 'We handle all starter and leaver processing including P45s, ensuring HMRC records are updated promptly.' },
  ...
  },
  {
    ...
    icon: '🏛',
    color: '#1a4a4a',
    heroDesc: 'Comprehensive HMRC compliance services ensuring every return is filed accurately and on time.',
    overview: 'Falling behind on HMRC obligations costs money through penalties and interest, and creates real stress. Our compliance team takes complete ownership of your obligations, ensuring you are always up to date and protected.',
    benefits: [
      ...
      'Penalty appeals and negotiations with HMRC',
    ],
    process: [
      { step: '01', title: 'Compliance Audit', desc: 'Review of all current HMRC obligations and identification of any outstanding matters.' },
      { step: '02', title: 'Returns Preparation', desc: 'Accurate preparation of all required returns using latest HMRC guidance.' },
      { step: '03', title: 'Review & Submit', desc: 'Client review and approval, followed by timely submission to HMRC.' },
      { step: '04', title: 'Deadline Management', desc: 'We track all deadlines proactively and ensure nothing is ever missed.' },
    ],
    faqs: [
      { q: 'What if I have missed filing deadlines?', a: 'We regularly help clients get back up to date. We can file overdue returns and in many cases negotiate penalty reductions with HMRC.' },
      ...
      { q: 'Can you deal with HMRC on my behalf?', a: 'Yes, we hold a 64-8 agent authorisation meaning we can deal with HMRC directly on all matters, removing the burden from you entirely.' },
    ],
  },
  {
